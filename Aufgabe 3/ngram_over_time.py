...
# Load the CSV file
data_0 = pd.read_csv("Data_Original.csv", sep="|", encoding="utf-16-LE")
...
output_file = "word_bigrams_overtime_all_data.csv"
with open(output_file, "w", encoding="utf-8") as file:
    file.write("Sender|Date|Ngram|Count\n")
    
    # Iterate over each sender's messages
    for sender_name, group in data_0.groupby("Sender Name"):
        ...
        for date, messages_on_date in group.groupby(group['Timestamp'].dt.date):
            ...
            # Generate n-grams
            n = 2  # Change n to the desired value for n-grams
